...
# Head icon links (browser + iPhone homescreen). Also provide a root-named apple-touch-icon.png.
components.html("""
<script>
(function() {
  const links = [
    { rel: 'apple-touch-icon', sizes: '180x180', href: 'apple-touch-icon.png?v=3' },
    { rel: 'icon', type: 'image/png', sizes: '32x32', href: 'favicon_32.png?v=3' },
    { rel: 'icon', type: 'image/png', sizes: '64x64', href: 'favicon_64.png?v=3' }
  ];
